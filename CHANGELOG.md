...
- Reference data management (Kontoinhaber, recipient accounts, IBAN mappings)
- Dashboard with financial overview

### Changed
- Major codebase refactoring:
  - Split lib/db.ts into domain-specific modules (kontoinhaber, recipient-accounts, transactions, reference-data)
  ...
  - Split api/reference_data.py into reference_data/ package (kontoinhaber, recipient_accounts, iban_mappings)
