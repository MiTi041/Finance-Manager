...
from finance_server.fints.common import TanRequired, TanTimeout, BankLoginRejected, VopConfirmationRequired
...
def create_transfer(request: TransferRequest) -> dict[str, Any]:
    ...
    except VopConfirmationRequired as err:
        raise HTTPException(status_code=409, detail={
            "code": "VOP_REQUIRED",
            "vop_token": err.vop_token,
            "result": err.result,
            "recipient_iban": err.recipient_iban,
            "recipient_name": err.recipient_name,
            "close_match_name": err.close_match_name,
            "other_identification": err.other_identification,
            "notice": err.notice,
        })
